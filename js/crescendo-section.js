...
class CrescendoSection {
    ...
    initializeSliderPosition() {
        if (!this.elements.slider || !this.elements.colorLayer || !this.elements.viewerContainer) {
    ...
    playCrescendoMusic(thumbnail) {
        ...
        if (!musicData) {
            ...
            console.warn('📋 Available files:', Object.keys(window.crescendoMusicData));
            return;
        }
    ...
    centerThumbnail(thumbnail) {
        ...
        const slideIndex = Array.from(this.swiperInstance.slides).findIndex(slide => {
    ...
    navigateImages(direction) {
        ...
        const currentIndex = visibleThumbs.findIndex(t => t.classList.contains('active'));
        let newIndex;
